...
\begin{itemize}
	...
	\item Our evaluation results on four popular software Java projects shows that our approach significantly improve the performance of defect prediction by 8.6\% and 5.4\% on both within-project and cross project defect prediction respectively in term of F1 compared to traditional approaches. 
\end{itemize}
