...
\begin{itemize}
	...
	\item We conduct experiments on four popular Java software projects. The results show that our approach significantly outperforms traditional defect prediction methods by 16.63\% and 18.95\% in terms of F1 score, for within-project and cross project defect prediction tasks, respectively. 
\end{itemize}
