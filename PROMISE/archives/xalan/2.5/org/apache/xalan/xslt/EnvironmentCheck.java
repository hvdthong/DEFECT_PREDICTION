 ...
 * @version $Id: EnvironmentCheck.java 337426 2003-04-10 14:16:33Z ilene $
 */
public class EnvironmentCheck
{
  ...
  protected boolean writeEnvironmentReport(Hashtable h)
  {
    ...
    logMsg(
      "#---- BEGIN writeEnvironmentReport($Revision: 337426 $): Useful stuff found: ----");
  ...
  public void appendEnvironmentReport(Node container, Document factory, Hashtable h)
  {
    ...
    try
    {
      ...
      envCheckNode.setAttribute("version", "$Revision: 337426 $");
