 ...
 * @version $Id: EnvironmentCheck.java 338232 2005-07-27 19:22:57Z mcnamara $
 */
public class EnvironmentCheck
{
  ...
  protected boolean writeEnvironmentReport(Hashtable h)
  {
    ...
    logMsg(
      "#---- BEGIN writeEnvironmentReport($Revision: 338232 $): Useful stuff found: ----");
  ...
  public void appendEnvironmentReport(Node container, Document factory, Hashtable h)
  {
    ...
    try
    {
      ...
      envCheckNode.setAttribute("version", "$Revision: 338232 $");
