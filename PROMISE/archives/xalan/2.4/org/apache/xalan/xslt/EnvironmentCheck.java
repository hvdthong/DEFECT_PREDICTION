 ...
 * @version $Id: EnvironmentCheck.java 336701 2002-08-29 01:28:51Z zongaro $
 */
public class EnvironmentCheck
{
  ...
  protected boolean writeEnvironmentReport(Hashtable h)
  {
    ...
    logMsg(
      "#---- BEGIN writeEnvironmentReport($Revision: 336701 $): Useful stuff found: ----");
  ...
  public void appendEnvironmentReport(Node container, Document factory, Hashtable h)
  {
    ...
    try
    {
      ...
      envCheckNode.setAttribute("version", "$Revision: 336701 $");
